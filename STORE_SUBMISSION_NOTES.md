# Store submission — Notes for certification

Paste the block below into the **"Notes for certification"** field every time you publish
to the Edge Add-ons / Chrome Web Store dashboard. Customers don't see it — it's only for
the store reviewers/testers. Keep it under the 2,000-character limit.

The text explains why each permission is needed and gives reviewers a concrete, copy-paste
test mod, because without enabling developer mode + a local mod folder the extension looks
inert and tends to get rejected.
